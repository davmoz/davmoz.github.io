 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zc(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function _o(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(zc())}function Kc(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function yo(){return uo.NODE_ADMIN===!0}function Xc(){return typeof indexedDB=="object"}function Qc(){return new Promise((t,e)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var r;e(((r=s.error)===null||r===void 0?void 0:r.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jc="FirebaseError";class Sn extends Error{constructor(e,n,i){super(n),this.code=e,this.customData=i,this.name=Jc,Object.setPrototypeOf(this,Sn.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,vo.prototype.create)}}class vo{constructor(e,n,i){this.service=e,this.serviceName=n,this.errors=i}create(e,...n){const i=n[0]||{},s=`${this.service}/${e}`,r=this.errors[e],o=r?Zc(r,i):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Sn(s,a,i)}}function Zc(t,e){return t.replace(eu,(n,i)=>{const s=e[i];return s!=null?String(s):`<${i}?>`})}const eu=/\{\$([^}]+)}/g;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uf{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,n){n==null?delete this.cache_[e]:this.cache_[e]=n}get(e){return ve(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ep{constructor(){this.counters_={}}incrementCounter(e,n=1){ve(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=n}get(){return qc(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Mi;function xp(t){Mi=t}const il=function(t){return typeof t=="number"?"number:"+Oa(t):"string:"+t},sl=function(t){if(t.isLeafNode()){const e=t.val();f(typeof e=="string"||typeof e=="number"||typeof e=="object"&&ve(e,".sv"),"Priority must be a string or number.")}else f(t===Mi||t.isEmpty(),"priority of unexpected type.");f(t===Mi||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yn extends Ka{constructor(e,n,i,s){super(),this.repoInfo_=e,this.onDataUpdate_=n,this.authTokenProvider_=i,this.appCheckTokenProvider_=s,this.log_=Yt("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,n){return n!==void 0?"tag$"+n:(f(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,n,i,s){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=yn.getListenId_(e,i),a={};this.listens_[o]=a;const l=Gr(e._queryParams);this.restRequest_(r+".json",l,(h,u)=>{let c=u;if(h===404&&(c=null,h=null),h===null&&this.onDataUpdate_(r,c,!1,i),tt(this.listens_,o)===a){let d;h?h===401?d="permission_denied":d="rest_error:"+h:d="ok",s(d,null)}})}unlisten(e,n){const i=yn.getListenId_(e,n);delete this.listens_[i]}get(e){const n=Gr(e._queryParams),i=e._path.toString(),s=new Tn;return this.restRequest_(i+".json",n,(r,o)=>{let a=o;r===404&&(a=null,r=null),r===null?(this.onDataUpdate_(i,a,!1,null),s.resolve(a)):s.reject(new Error(a))}),s.promise}refreshAuthToken(e){}restRequest_(e,n={},i){return n.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then(([s,r])=>{s&&s.accessToken&&(n.auth=s.accessToken),r&&r.token&&(n.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+iu(n);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(i&&a.readyState===4){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let l=null;if(a.status>=200&&a.status<300){try{l=bt(a.responseText)}catch{J("Failed to parse JSON response for "+o+": "+a.responseText)}i(null,l)}else a.status!==401&&a.status!==404&&J("Got unsuccessful REST response for "+o+" Status: "+a.status),i(a.status);i=null}},a.open("GET",o,!0),a.send()})}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wn{constructor(e,n,i){this.path=e,this.affectedTree=n,this.revert=i,this.type=de.ACK_USER_WRITE,this.source=ll()}operationForChild(e){if(v(this.path)){if(this.affectedTree.value!=null)return f(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new D(e));return new wn(b(),n,this.revert)}}else return f(y(this.path)===e,"operationForChild called for unrelated child."),new wn(A(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class He{constructor(e,n,i){this.source=e,this.path=n,this.snap=i,this.type=de.OVERWRITE}operationForChild(e){return v(this.path)?new He(this.source,b(),this.snap.getImmediateChild(e)):new He(this.source,A(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{constructor(e,n,i){this.source=e,this.path=n,this.children=i,this.type=de.MERGE}operationForChild(e){if(v(this.path)){const n=this.children.subtree(new D(e));return n.isEmpty()?null:n.value?new He(this.source,b(),n.value):new Lt(this.source,b(),n)}else return f(y(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Lt(this.source,A(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ps{constructor(e,n,i){this.node_=e,this.fullyInitialized_=n,this.filtered_=i}isFullyInitialized(){return this.fullyInitialized_}isFiltered(){return this.filtered_}isCompleteForPath(e){if(v(e))return this.isFullyInitialized()&&!this.filtered_;const n=y(e);return this.isCompleteForChild(n)}isCompleteForChild(e){return this.isFullyInitialized()&&!this.filtered_||this.node_.hasChild(e)}getNode(){return this.node_}}function ig(t,e,n,i){const s=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&t.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Xp(o.childName,o.snapshotNode))}),yt(t,s,"child_removed",e,i,n),yt(t,s,"child_added",e,i,n),yt(t,s,"child_moved",r,i,n),yt(t,s,"child_changed",e,i,n),yt(t,s,"value",e,i,n),s}function yt(t,e,n,i,s,r){const o=i.filter(a=>a.type===n);o.sort((a,l)=>rg(t,a,l)),o.forEach(a=>{const l=sg(t,a,r);s.forEach(h=>{h.respondsTo(a.type)&&e.push(h.createEvent(l,t.query_))})})}function sg(t,e,n){return e.type==="value"||e.type==="child_removed"||(e.prevName=n.getPredecessorChildName(e.childName,e.snapshotNode,t.index_)),e}function rg(t,e,n){if(e.childName==null||n.childName==null)throw ot("Should only compare child_ events.");const i=new E(e.childName,e.snapshotNode),s=new E(n.childName,n.snapshotNode);return t.index_.compare(i,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ae{constructor(e){this.writeTree_=e}static empty(){return new ae(new N(null))}}function St(t,e,n){if(v(e))return new ae(new N(n));{const i=t.writeTree_.findRootMostValueAndPath(e);if(i!=null){const s=i.path;let r=i.value;const o=ne(s,e);return r=r.updateChild(o,n),new ae(t.writeTree_.set(s,r))}else{const s=new N(n),r=t.writeTree_.setTree(e,s);return new ae(r)}}}function Yr(t,e,n){let i=t;return se(n,(s,r)=>{i=St(i,k(e,s),r)}),i}function zr(t,e){if(v(e))return ae.empty();{const n=t.writeTree_.setTree(e,new N(null));return new ae(n)}}function Fi(t,e){return $e(t,e)!=null}function $e(t,e){const n=t.writeTree_.findRootMostValueAndPath(e);return n!=null?t.writeTree_.get(n.path).getChild(ne(n.path,e)):null}function Kr(t){const e=[],n=t.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild($,(i,s)=>{e.push(new E(i,s))}):t.writeTree_.children.inorderTraversal((i,s)=>{s.value!=null&&e.push(new E(i,s.value))}),e}function Se(t,e){if(v(e))return t;{const n=$e(t,e);return n!=null?new ae(new N(n)):new ae(t.writeTree_.subtree(e))}}function Ui(t){return t.writeTree_.isEmpty()}function st(t,e){return fl(b(),t.writeTree_,e)}function fl(t,e,n){if(e.value!=null)return n.updateChild(t,e.value);{let i=null;return e.children.inorderTraversal((s,r)=>{s===".priority"?(f(r.value!==null,"Priority writes must always be leaf nodes"),i=r.value):n=fl(k(t,s),r,n)}),!n.getChild(t).isEmpty()&&i!==null&&(n=n.updateChild(k(t,".priority"),i)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eg{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const wl=new Eg;class Ms{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new Ps(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Os(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:je(this.viewCache_),r=vg(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}function Cg(t,e){f(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),f(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function Tg(t,e,n,i,s){const r=new wg;let o,a;if(n.type===de.OVERWRITE){const h=n;h.source.fromUser?o=Bi(t,e,h.path,h.snap,i,s,r):(f(h.source.fromServer,"Unknown source."),a=h.source.tagged||e.serverCache.isFiltered()&&!v(h.path),o=Cn(t,e,h.path,h.snap,i,s,a,r))}else if(n.type===de.MERGE){const h=n;h.source.fromUser?o=bg(t,e,h.path,h.children,i,s,r):(f(h.source.fromServer,"Unknown source."),a=h.source.tagged||e.serverCache.isFiltered(),o=Hi(t,e,h.path,h.children,i,s,a,r))}else if(n.type===de.ACK_USER_WRITE){const h=n;h.revert?o=Ag(t,e,h.path,i,s,r):o=Ig(t,e,h.path,h.affectedTree,i,s,r)}else if(n.type===de.LISTEN_COMPLETE)o=Ng(t,e,n.path,i,r);else throw ot("Unknown operation type: "+n.type);const l=r.getChanges();return Sg(e,o,l),{viewCache:o,changes:l}}function Sg(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=Li(t);(n.length>0||!t.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(Yp(Li(e)))}}function El(t,e,n,i,s,r){const o=e.eventCache;if(En(i,n)!=null)return e;{let a,l;if(v(n))if(f(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const h=je(e),u=h instanceof C?h:C.EMPTY_NODE,c=_l(i,u);a=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const h=Wi(i,je(e));a=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const h=y(n);if(h===".priority"){f(be(n)===1,"Can't have a priority with additional path components");const u=o.getNode();l=e.serverCache.getNode();const c=Xr(i,n,u,l);c!=null?a=t.filter.updatePriority(u,c):a=o.getNode()}else{const u=A(n);let c;if(o.isCompleteForChild(h)){l=e.serverCache.getNode();const d=Xr(i,n,o.getNode(),l);d!=null?c=o.getNode().getImmediateChild(h).updateChild(u,d):c=o.getNode().getImmediateChild(h)}else c=Os(i,h,e.serverCache);c!=null?a=t.filter.updateChild(o.getNode(),h,c,u,s,r):a=o.getNode()}}return Tt(e,a,o.isFullyInitialized()||v(n),t.filter.filtersNodes())}}function Cn(t,e,n,i,s,r,o,a){const l=e.serverCache;let h;const u=o?t.filter:t.filter.getIndexedFilter();if(v(n))h=u.updateFullNode(l.getNode(),i,null);else if(u.filtersNodes()&&!l.isFiltered()){const g=l.getNode().updateChild(n,i);h=u.updateFullNode(l.getNode(),g,null)}else{const g=y(n);if(!l.isCompleteForPath(n)&&be(n)>1)return e;const m=A(n),K=l.getNode().getImmediateChild(g).updateChild(m,i);g===".priority"?h=u.updatePriority(l.getNode(),K):h=u.updateChild(l.getNode(),g,K,m,wl,null)}const c=dl(e,h,l.isFullyInitialized()||v(n),u.filtersNodes()),d=new Ms(s,c,r);return El(t,c,n,s,d,a)}function Bi(t,e,n,i,s,r,o){const a=e.eventCache;let l,h;const u=new Ms(s,e,r);if(v(n))h=t.filter.updateFullNode(e.eventCache.getNode(),i,o),l=Tt(e,h,!0,t.filter.filtersNodes());else{const c=y(n);if(c===".priority")h=t.filter.updatePriority(e.eventCache.getNode(),i),l=Tt(e,h,a.isFullyInitialized(),a.isFiltered());else{const d=A(n),g=a.getNode().getImmediateChild(c);let m;if(v(d))m=i;else{const I=u.getCompleteChild(c);I!=null?Qa(d)===".priority"&&I.getChild(Za(d)).isEmpty()?m=I:m=I.updateChild(d,i):m=C.EMPTY_NODE}if(g.equals(m))l=e;else{const I=t.filter.updateChild(a.getNode(),c,m,d,u,o);l=Tt(e,I,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function Qr(t,e){return t.eventCache.isCompleteForChild(e)}function bg(t,e,n,i,s,r,o){let a=e;return i.foreach((l,h)=>{const u=k(n,l);Qr(e,y(u))&&(a=Bi(t,a,u,h,s,r,o))}),i.foreach((l,h)=>{const u=k(n,l);Qr(e,y(u))||(a=Bi(t,a,u,h,s,r,o))}),a}function Jr(t,e,n){return n.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function Hi(t,e,n,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,h;v(n)?h=i:h=new N(null).setTree(n,i);const u=e.serverCache.getNode();return h.children.inorderTraversal((c,d)=>{if(u.hasChild(c)){const g=e.serverCache.getNode().getImmediateChild(c),m=Jr(t,g,d);l=Cn(t,l,new D(c),m,s,r,o,a)}}),h.children.inorderTraversal((c,d)=>{const g=!e.serverCache.isCompleteForChild(c)&&d.value===void 0;if(!u.hasChild(c)&&!g){const m=e.serverCache.getNode().getImmediateChild(c),I=Jr(t,m,d);l=Cn(t,l,new D(c),I,s,r,o,a)}}),l}function Ig(t,e,n,i,s,r,o){if(En(s,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(v(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return Cn(t,e,n,l.getNode().getChild(n),s,r,a,o);if(v(n)){let h=new N(null);return l.getNode().forEachChild(Je,(u,c)=>{h=h.set(new D(u),c)}),Hi(t,e,n,h,s,r,a,o)}else return e}else{let h=new N(null);return i.foreach((u,c)=>{const d=k(n,u);l.isCompleteForPath(d)&&(h=h.set(u,l.getNode().getChild(d)))}),Hi(t,e,n,h,s,r,a,o)}}function Ng(t,e,n,i,s){const r=e.serverCache,o=dl(e,r.getNode(),r.isFullyInitialized()||v(n),r.isFiltered());return El(t,o,n,i,wl,s)}function Ag(t,e,n,i,s,r){let o;if(En(i,n)!=null)return e;{const a=new Ms(i,e,s),l=e.eventCache.getNode();let h;if(v(n)||y(n)===".priority"){let u;if(e.serverCache.isFullyInitialized())u=Wi(i,je(e));else{const c=e.serverCache.getNode();f(c instanceof C,"serverChildren would be complete if leaf node"),u=_l(i,c)}u=u,h=t.filter.updateFullNode(l,u,r)}else{const u=y(n);let c=Os(i,u,e.serverCache);c==null&&e.serverCache.isCompleteForChild(u)&&(c=l.getImmediateChild(u)),c!=null?h=t.filter.updateChild(l,u,c,A(n),a,r):e.eventCache.getNode().hasChild(u)?h=t.filter.updateChild(l,u,C.EMPTY_NODE,A(n),a,r):h=l,h.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=Wi(i,je(e)),o.isLeafNode()&&(h=t.filter.updateFullNode(h,o,r)))}return o=e.serverCache.isFullyInitialized()||En(i,b())!=null,Tt(e,h,o,t.filter.filtersNodes())}}function Dg(t,e){const n=je(t.viewCache_);return n&&(t.query._queryParams.loadsAllData()||!v(e)&&!n.getImmediateChild(y(e)).isEmpty())?n.getChild(e):null}function Zr(t,e,n,i){e.type===de.MERGE&&e.source.queryId!==null&&(f(je(t.viewCache_),"We should always have a full cache before handling merges"),f(Li(t.viewCache_),"Missing event cache, even though we have a server cache"));const s=t.viewCache_,r=Tg(t.processor_,s,e,n,i);return Cg(t.processor_,r.viewCache),f(r.viewCache.serverCache.isFullyInitialized()||!s.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),t.viewCache_=r.viewCache,Rg(t,r.changes,r.viewCache.eventCache.getNode(),null)}function Rg(t,e,n,i){const s=i?[i]:t.eventRegistrations_;return ig(t.eventGenerator_,e,n,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let to;function Pg(t){f(!to,"__referenceConstructor has already been defined"),to=t}class no{constructor(e){this.listenProvider_=e,this.syncPointTree_=new N(null),this.pendingWriteTree_=yg(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Cl(t,e,n,i,s){return ag(t.pendingWriteTree_,e,n,i,s),s?Hn(t,new He(ll(),e,n)):[]}function Me(t,e,n=!1){const i=lg(t.pendingWriteTree_,e);if(hg(t.pendingWriteTree_,e)){let r=new N(null);return i.snap!=null?r=r.set(b(),!0):se(i.children,o=>{r=r.set(new D(o),!0)}),Hn(t,new wn(i.path,r,n))}else return[]}function Bn(t,e,n){return Hn(t,new He(hl(),e,n))}function Og(t,e,n){const i=N.fromObject(n);return Hn(t,new Lt(hl(),e,i))}function Mg(t,e,n,i){const s=bl(t,i);if(s!=null){const r=Il(s),o=r.path,a=r.queryId,l=ne(o,e),h=new He(cl(a),l,n);return Nl(t,o,h)}else return[]}function xg(t,e,n,i){const s=bl(t,i);if(s){const r=Il(s),o=r.path,a=r.queryId,l=ne(o,e),h=N.fromObject(n),u=new Lt(cl(a),l,h);return Nl(t,o,u)}else return[]}function Fs(t,e,n){const s=t.pendingWriteTree_,r=t.syncPointTree_.findOnPath(e,(o,a)=>{const l=ne(o,e),h=Ls(a,l);if(h)return h});return ml(s,e,r,n,!0)}function Hn(t,e){return Tl(e,t.syncPointTree_,null,pl(t.pendingWriteTree_,b()))}function Tl(t,e,n,i){if(v(t.path))return Sl(t,e,n,i);{const s=e.get(b());n==null&&s!=null&&(n=Ls(s,b()));let r=[];const o=y(t.path),a=t.operationForChild(o),l=e.children.get(o);if(l&&a){const h=n?n.getImmediateChild(o):null,u=yl(i,o);r=r.concat(Tl(a,l,h,u))}return s&&(r=r.concat(xs(s,t,i,n))),r}}function Sl(t,e,n,i){const s=e.get(b());n==null&&s!=null&&(n=Ls(s,b()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=n?n.getImmediateChild(o):null,h=yl(i,o),u=t.operationForChild(o);u&&(r=r.concat(Sl(u,a,l,h)))}),s&&(r=r.concat(xs(s,t,i,n))),r}function bl(t,e){return t.tagToQueryMap.get(e)}function Il(t){const e=t.indexOf("$");return f(e!==-1&&e<t.length-1,"Bad queryKey."),{queryId:t.substr(e+1),path:new D(t.substr(0,e))}}function Nl(t,e,n){const i=t.syncPointTree_.get(e);f(i,"Missing sync point for query tag that we're tracking");const s=pl(t.pendingWriteTree_,e);return xs(i,n,s,null)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
